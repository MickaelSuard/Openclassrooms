 ...
 */
final class Version20241115151522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER last_connected_at TYPE DATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER last_connected_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
